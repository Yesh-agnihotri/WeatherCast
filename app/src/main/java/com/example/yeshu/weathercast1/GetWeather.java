...
public class GetWeather
{
    ...
    public interface Response //to pass the values from asynctask to processfinish
    {
        ...
        void processFinish(double output0,double output01,String output1, String output2, String output3, String output4, String output5,String output6,String output7,String output8,String output9,String output10,String output11,String output12);
    }
        ...
        protected void onPostExecute(JSONObject jsonWeather) {
            try {
...

                {
                    ...
                    delegate.processFinish(lat,lon,cityname,condition, temperature, humidity, pressure,lastUpdate,iconText,speed,temp_max,temp_min,sun_rise,sun_set);
